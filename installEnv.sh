...
echo "Creating the conda environment 'DisasterVision' with Python 3.9..."

# Create the environment
conda create -n DisasterVision python=3.9 -y

# Activate the environment
source activate DisasterVision
...
echo "Environment setup complete! You can now activate the environment using 'conda activate DisasterVision'."
